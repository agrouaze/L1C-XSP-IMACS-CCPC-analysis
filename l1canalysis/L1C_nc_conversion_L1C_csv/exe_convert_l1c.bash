...
pbspath="/home1/datahome/agrouaze/git/L1C-XSP_IMACS-analysis/L1C_nc_conversion_L1C_csv/convert_l1c.pbs"
...
$prunexe --split-max-jobs=700 --mem=500m --name l1cPRUN_S1AB_B07 --max-time=02:00:00 -e $pbspath $listing